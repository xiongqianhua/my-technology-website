...
//         scene.background = new THREE.Color('#FFFFFF'); //设置背景色
...
//         document.getElementById("mapId").appendChild(labelRenderer.domElement);
...
//         document.getElementById("mapId").appendChild(renderer.domElement);
...
//             });
// }, []);
   return <div id="self-introduction"><div id="mapId" className={styles.mapId}></div></div>
}
